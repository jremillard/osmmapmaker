...
Output::Output(QString nameIn) : name_(nameIn)
{
}
...
TileOutput::TileOutput(QString name) : Output(name)
{
	maxZoom_ = 18;
	minZoom_ = 13;
	tileSizePixels_ = 256;
...
TileOutput::TileOutput(QDomElement outputElement) : Output(outputElement)
{
